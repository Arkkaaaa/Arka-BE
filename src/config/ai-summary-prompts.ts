const SESSION_PARTICIPANT_INSTRUCTION =
  'Untuk participant, summaryText harus 3 sampai 4 kalimat dan maksimal 600 karakter: tulis narasi yang hangat, mudah dipahami, menyebut capaian angka, menjelaskan maknanya dalam konteks permainan, lalu beri semangat dan fokus bermain berikutnya yang realistis.';

const SESSION_CLINICIAN_INSTRUCTION =
  'Untuk clinician, summaryText harus 4 sampai 5 kalimat dan maksimal 650 karakter: analisis hubungan antarmetrik secara lebih tajam, termasuk konsistensi, ketepatan, kecepatan, atau kestabilan performa permainan; bandingkan angka yang tersedia dan sebutkan pola serta fokus permainan berikutnya yang dapat diamati.';

const MODE_PARTICIPANT_INSTRUCTION =
  'participantSummary harus 3 sampai 4 kalimat dan maksimal 650 karakter: jelaskan capaian angka, maknanya dalam permainan, pola yang terlihat, lalu beri semangat dan fokus bermain berikutnya yang realistis.';

const MODE_CLINICIAN_INSTRUCTION =
  'clinicianSummary harus 4 sampai 5 kalimat dan maksimal 900 karakter: analisis hubungan skor, ketepatan, kekuatan, kecepatan, atau kestabilan yang tersedia; jelaskan pola serta fokus pengamatan sesi berikutnya.';

const AGGREGATE_PARTICIPANT_INSTRUCTION =
...
const AGGREGATE_CLINICIAN_INSTRUCTION =
...
export const SESSION_SUMMARY_SYSTEM_PROMPT = [
  ...
  SESSION_PARTICIPANT_INSTRUCTION,
  SESSION_CLINICIAN_INSTRUCTION,
...
export const PARTICIPANT_MODE_SYSTEM_PROMPT = [
  ...
  MODE_PARTICIPANT_INSTRUCTION,
  MODE_CLINICIAN_INSTRUCTION,
...
export const PARTICIPANT_AGGREGATE_SYSTEM_PROMPT = [
  ...
  'Balas JSON ketat dengan participantSummary dan clinicianSummary.',
  AGGREGATE_PARTICIPANT_INSTRUCTION,
  AGGREGATE_CLINICIAN_INSTRUCTION,
